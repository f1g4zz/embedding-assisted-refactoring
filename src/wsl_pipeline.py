...
GIGANTI = ["thunderbird-android", "dbeaver", "sonarqube", "geode", "asterixdb",
           ...
           "wildfly", "payara", "h-store", "sakai","gwt","metasfresh"]
...
PROJECTS = [
    ...
    "felix", "qpid-broker-j", "bazel", "netty", 
    ...
    "cassandra", "hibernate-orm", "solr", "lucene", "intellij-plugins",
    "deeplearning4j", "camel", "graal", "cloudstack-archive", "hive",
    "cloudstack", "hadoop-common", "hbase", "drools", "hadoop", "metasfresh",
    "wildfly", "payara", "h-store", "freeplane", "sakai", "thredds", "gwt"
]
    ...
    for sub_id, sub_path in tasks:
        ...
        try:
            ...
            if edge_count > 0:
                ...
                print(" OK.", flush=True); safe_log(f"SUCCESS: {sub_id}")
